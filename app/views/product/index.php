        ...
        <nav class="desktop-navigation-menu">
            <div class="container">
                <ul class="desktop-menu-category-list">
                    <li class="menu-category"> <a href="<?= BASE_URL ?>/home/index2" class="menu-title">Home</a> </li>
                ...
                <div class="product-box">
                            ...
                            <div class="showcase-container">
                                <div class="showcase">
                                    <div class="showcase-banner">
                                        <img src="<?= ASSETS ?>/images2/products/shampoo.jpg"
                    ...
                    <div class="product-main">
                        ...
                        <div class="product-grid">
                            <div class="showcase">
                                <div class="showcase-banner"> <img src="<?= ASSETS ?>/images2/products/jacket-3.jpg"
                                        alt="Mens Winter Leathers Jackets" width="300" class="product-img default"> <img
                                        src="<?= ASSETS ?>/images2/products/jacket-4.jpg"
                                ...
                                <div class="showcase-content"> <a href="#" class="showcase-category">jacket</a> <a
                                        href="#">
